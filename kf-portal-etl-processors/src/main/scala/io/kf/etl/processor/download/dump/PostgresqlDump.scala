...
import io.kf.etl.processor.common.ProcessorCommonDefinitions.PostgresqlDBTables
import io.kf.etl.processor.common.exceptions.KfExceptions.DataDumpTargetNotSupportedException
