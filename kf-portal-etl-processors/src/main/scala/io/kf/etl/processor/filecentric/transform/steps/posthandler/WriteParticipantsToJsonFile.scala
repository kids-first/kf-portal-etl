...
class WriteParticipantsToJsonFile(override val ctx: FileCentricStepContext, filename:String) extends StepExecutable[Dataset[Participant], Dataset[Participant]]{
