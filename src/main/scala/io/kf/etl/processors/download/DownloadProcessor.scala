...
object DownloadProcessor {
  def apply(studyId: String, sink: Boolean = false)(implicit WSClient: StandaloneWSClient, ec: ExecutionContext, spark: SparkSession, config: Config, system: ActorSystem): EntityDataSet = {
