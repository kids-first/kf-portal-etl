...
object EntityDataExtractor {
  ...
  implicit val participant: EntityDataExtractor[EParticipant] =
    new EntityDataExtractor[EParticipant] {
  ...
  implicit val family: EntityDataExtractor[EFamily] =
    new EntityDataExtractor[EFamily] {
      override def extract(json: JValue): EFamily = json.extract[EFamily]
    }

  implicit val biospecimen: EntityDataExtractor[EBiospecimen] =
    new EntityDataExtractor[EBiospecimen] {
      override def extract(json: JValue): EBiospecimen = {
        ...
        entity.copy(
          ...
          sequencing_center_id = getIdFromLink("sequencing_center", json)
        )
      }
    }

  implicit val diagnosis: EntityDataExtractor[EDiagnosis] =
    new EntityDataExtractor[EDiagnosis] {
  ...
  implicit val familyRelationship: EntityDataExtractor[EFamilyRelationship] =
    new EntityDataExtractor[EFamilyRelationship] {
  ...
  implicit val genomicFile: EntityDataExtractor[EGenomicFile] =
    new EntityDataExtractor[EGenomicFile] {
      override def extract(json: JValue): EGenomicFile =
        json.extract[EGenomicFile]
    }

  implicit val biospecimenGenomicFile
      : EntityDataExtractor[EBiospecimenGenomicFile] =
    new EntityDataExtractor[EBiospecimenGenomicFile] {
  ...
  implicit val biospecimeDiagnosis: EntityDataExtractor[EBiospecimenDiagnosis] =
    new EntityDataExtractor[EBiospecimenDiagnosis] {
  ...
  implicit val investigator: EntityDataExtractor[EInvestigator] =
    new EntityDataExtractor[EInvestigator] {
      override def extract(json: JValue): EInvestigator =
        json.extract[EInvestigator]
    }

  implicit val outcome: EntityDataExtractor[EOutcome] =
    new EntityDataExtractor[EOutcome] {
  ...
  implicit val phenotype: EntityDataExtractor[EPhenotype] =
    new EntityDataExtractor[EPhenotype] {
  ...
  implicit val seqExp: EntityDataExtractor[ESequencingExperiment] =
    new EntityDataExtractor[ESequencingExperiment] {
      override def extract(json: JValue): ESequencingExperiment =
        json.extract[ESequencingExperiment]
    }

  implicit val seqExpGenomicFile
      : EntityDataExtractor[ESequencingExperimentGenomicFile] =
    new EntityDataExtractor[ESequencingExperimentGenomicFile] {
  ...
  implicit val study: EntityDataExtractor[EStudy] =
    new EntityDataExtractor[EStudy] {
      override def extract(json: JValue): EStudy = json.extract[EStudy]
    }

  implicit val studyFile: EntityDataExtractor[EStudyFile] =
    new EntityDataExtractor[EStudyFile] {
  ...
  implicit val sequencingCenters: EntityDataExtractor[ESequencingCenter] =
    new EntityDataExtractor[ESequencingCenter] {
      override def extract(json: JValue): ESequencingCenter =
        json.extract[ESequencingCenter]
    }
}
