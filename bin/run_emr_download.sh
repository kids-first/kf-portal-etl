#!/bin/bash
set -x
study_ids=${1:-"SD_46SK55A3,SD_7NQ9151J,SD_NMVV8A1Y,SD_BHJXBDQK,SD_EKWJJJQG,SD_YGVA0E1C,SD_9PYZAHHE,SD_ZXJFFMEF,SD_W0V965XZ,SD_DZTB5HRR,SD_6FPYJQBR,SD_DYPMEHHF,SD_PET7Q6F2,SD_2CEKQ05V,SD_Z6MWD3H0"}
release_id=$2
